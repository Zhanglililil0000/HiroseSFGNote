...
\\
&\quad \times \Bigg[ 
\sum_{n''} \frac{(r_k)_{nn''} (r_j)_{n''n'} + (r_j)_{nn''} (r_k)_{n''n'}}{\omega_1 - \omega_{n''n'} + i\Gamma_{n''n'}} (\rho^{(0)}_{n'n'} - \rho^{(0)}_{n''n''}) 
\\
&\quad - \frac{(r_k)_{nn''} (r_j)_{n''n'} + (r_j)_{nn''} (r_k)_{n''n'}}{\omega_1 - \omega_{nn''} + i\Gamma_{nn''}} (\rho^{(0)}_{n''n''} - \rho^{(0)}_{nn}) 
\Bigg] 
\tag{C-8}
\end{align*}
$$
...
&\quad 
\times \Bigg\{ 
\left[ \sum_{n''} \frac{(r_k)_{nn''} (r_j)_{n''n'}}{\omega - \omega_{n''n'} + i\Gamma_{n''n'}} - \frac{(r_j)_{nn''} (r_k)_{n''n'}}{\omega + \omega_{n''n'} - i\Gamma_{n''n'}} 
\right] (\rho^{(0)}_{n'n'} - \rho^{(0)}_{n''n''}) 
\\
&\quad - \left[ 
\frac{(r_j)_{nn''} (r_k)_{n''n'}}{\omega - \omega_{nn''} + i\Gamma_{nn''}} - \frac{(r_k)_{nn''} (r_j)_{n''n'}}{\omega + \omega_{nn''} - i\Gamma_{nn''}} 
\right] (\rho^{(0)}_{n''n''} - \rho^{(0)}_{nn}) 
\Bigg\} 
\tag{C-9}
\end{align*}
$$
...
\\
\rho^{(l)}(\omega)_{nn'} &= \frac{e}{\hbar} E_j(\omega_j) \frac{\sum_{n''} \left[ (r_j)_{nn''} \rho^{(l-1)}(\omega - \omega_j)_{n''n'} - (r_j)_{n''n'} \rho^{(l-1)}(\omega - \omega_j)_{nn''} \right]}{\omega - \omega_{nn'} + i\Gamma_{nn'}} \quad (C-10)
\end{align*}
$$
